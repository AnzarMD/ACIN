  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800 shadow-sm">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-semibold text-gray-900 dark:text-gray-100">Product Condition</h3>
      </div>
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <span
          className={`text-lg font-bold px-3 py-1 rounded ${
            gradeColors[analysis.grade] || "text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-700"
          }`}
        >
      ...
      <div className="space-y-2 text-sm">
        <div className="flex justify-between">
          <span className="text-gray-500 dark:text-gray-400">Usage Level</span>
      ...
      {analysis.defects.length > 0 && (
        <div className="mt-4">
          <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase mb-2">Defects Found</p>
